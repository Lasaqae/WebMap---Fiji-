...
map.getView().fit([19597284.501929, -2149068.161705, 20239491.642039, -1782467.628045], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Map of Administrative Boundaries and Weather Stations - Fiji</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (683 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The map of Fiji integrates multiple administrative and meteorological layers. These include 86 Tikinas and 1,181 villages, alongside a diverse network of weather and hydrometric stations. The stations are categorized as follows: Automatic Weather Stations (28), Telemetered Tipping Bucket Raingauges (38), Manual Synoptic Stations (16), Manual Climate Stations (17), Sector Office Manual Rainfall Stations (31), a single Manual Rainfall Station in Vatuwiri, and Hydrometric Stations (30). Each station type records specific parameters such as rainfall, temperature, humidity, wind, evaporation, cloud cover, and water levels, providing comprehensive coverage across the Fiji Islands.';
            }
